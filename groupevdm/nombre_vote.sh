#Ce code permet d'afficher le nombre de "Je valide, c'est une VDM" de la catégorie "argent" Pour cela, il faut d'abord se placer dans le répertoire de la catégorie "argent"

#!/bin/sh
cd www.viedemerde.fr/argent
